...
module "postgres_schema" {
  ...
  password_secret = {
    id                      = azurerm_key_vault_secret.training_log_db_password.id
    resource_versionless_id = azurerm_key_vault_secret.training_log_db_password.resource_versionless_id
  }
}
