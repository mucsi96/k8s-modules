...
| `create_postgres_database` | Installs PostgreSQL with a retained host-path volume and `ServiceMonitor`, then provisions an isolated owner role for each application schema. |
